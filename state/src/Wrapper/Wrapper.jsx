...
import Form from "../Wrapper/Form/Form";
...
class Wrapper extends Component {
    ...
    render() {
        ...
        const {phones, cart, isCartSow,text, email, password } = this.state
        ...
        return (
            <div>
               ...
               <Form
                   ...
                   />
               <CartModal isCartSow = {isCartSow} toggleCart = {this.toggleCart}/>
               <PhoneList arr = {phones} addToCart = {this.addToCart}/> 
               <Form/>
